...
export declare class DecimalNumberPipe implements PipeTransform, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<DecimalNumberPipe, never>;
    static ɵpipe: ɵngcc0.ɵɵPipeDefWithMeta<DecimalNumberPipe, "adfDecimalNumber">;
}

//# sourceMappingURL=decimal-number.pipe.d.ts.map