...
import { IdentityGroupModel, IdentityGroupQueryResponse, IdentityGroupCountModel, IdentityGroupQueryCloudRequestModel, IdentityGroupSearchParam } from '../models/identity-group.model';
...
export interface IdentityGroupServiceInterface {
    ...
    updateGroup(groupId: string, updatedGroup: IdentityGroupModel): any;
