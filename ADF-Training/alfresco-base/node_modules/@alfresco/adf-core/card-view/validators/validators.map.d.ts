...
declare const validators: {
    minmax: (parameters: MinMaxValidatorParams) => CardViewItemMinMaxValidator;
    regex: (parameters: MatchValidatorParams) => CardViewItemMatchValidator;
    length: (parameters: LengthValidatorParams) => CardViewItemLengthValidator;
};
