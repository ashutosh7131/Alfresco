...
export declare class ProcessInstanceTasksComponent implements OnInit, OnChanges, OnDestroy {
    ...
    clickTask(task: TaskDetailsModel): void;
    clickStartTask(): void;
    showStartDialog(): void;
    closeStartDialog(): void;
    onRefreshClicked(): void;
    onFormContentClick(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ProcessInstanceTasksComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<ProcessInstanceTasksComponent, "adf-process-instance-tasks", never, { "showRefreshButton": "showRefreshButton"; "processInstanceDetails": "processInstanceDetails"; }, { "error": "error"; "taskClick": "taskClick"; }, never, never>;
}

//# sourceMappingURL=process-instance-tasks.component.d.ts.map