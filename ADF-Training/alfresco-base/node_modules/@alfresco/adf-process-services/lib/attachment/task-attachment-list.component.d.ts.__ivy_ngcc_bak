...
export declare class TaskAttachmentListComponent implements OnChanges, AfterContentInit {
    ...
    taskId: string;
    disabled: boolean;
    attachmentClick: EventEmitter<any>;
    ...
    deleteAttachmentById(contentId: number): void;
    isEmpty(): boolean;
