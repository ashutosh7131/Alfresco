...
export declare class ServiceTaskListCloudService extends BaseCloudService {
    private logService;
    constructor(apiService: AlfrescoApiService, appConfigService: AppConfigService, logService: LogService);
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<ServiceTaskListCloudService, never>;
}

//# sourceMappingURL=service-task-list-cloud.service.d.ts.map