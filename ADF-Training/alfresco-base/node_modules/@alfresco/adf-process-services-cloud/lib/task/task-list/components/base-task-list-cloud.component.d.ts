...
export declare abstract class BaseTaskListCloudComponent extends DataTableSchema implements OnChanges, AfterContentInit, PaginatedComponent, OnDestroy, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<BaseTaskListCloudComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<BaseTaskListCloudComponent, never, never, { "appName": "appName"; "selectionMode": "selectionMode"; "multiselect": "multiselect"; "stickyHeader": "stickyHeader"; "showActions": "showActions"; "actionsPosition": "actionsPosition"; "showContextMenu": "showContextMenu"; "sorting": "sorting"; }, { "showRowContextMenu": "showRowContextMenu"; "showRowActionsMenu": "showRowActionsMenu"; "executeRowAction": "executeRowAction"; "rowClick": "rowClick"; "rowsSelected": "rowsSelected"; "success": "success"; "error": "error"; }, ["emptyCustomContent"]>;
}

//# sourceMappingURL=base-task-list-cloud.component.d.ts.map