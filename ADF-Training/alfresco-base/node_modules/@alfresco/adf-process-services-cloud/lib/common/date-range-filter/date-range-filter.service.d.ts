...
export declare class DateRangeFilterService {
    ...
    isDateRangeType(type: DateCloudFilterType): boolean;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<DateRangeFilterService, never>;
}

//# sourceMappingURL=date-range-filter.service.d.ts.map