...
export declare type FormFieldRepresentation = (DateField | DateTimeField | TextField | AttachFileField | DropDownField | RadioField | TypeaheadField | PeopleField | AmountField | NumberField | CheckboxField | HyperlinkField);
...
export declare enum PeopleModeOptions {
    single = "single",
    multiple = "multiple"
}
