...
export declare class PermissionListComponent {
    ...
    constructor(permissionList: PermissionListService);
    ngOnInit(): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PermissionListComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PermissionListComponent, "adf-permission-list", never, { "nodeId": "nodeId"; }, { "error": "error"; "update": "update"; }, never, never>;
}

//# sourceMappingURL=permission-list.component.d.ts.map